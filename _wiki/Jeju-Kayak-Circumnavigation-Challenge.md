---
permalink: /wiki/Jeju-Kayak-Circumnavigation-Challenge/
title: "Jeju Kayak Circumnavigation Challenge"
date: 2026-05-20
tags: [seed, bucketlist, jeju, kayaking]
---

![](/assets/wiki/Gemini_Generated_Image_itao8witao8witao.png)

Paddling a sea kayak around Jeju Island is the toughest of the three legs in the [Jeju Trifecta](/wiki/Jeju-Trifecta/). The coastline is roughly **253 km**. The Pacific swells on the south coast are exposed and unforgiving. The island's nickname is **Samdado (삼다도)** — "the island of three abundances": rocks, wind, and women — and two of those three are problems for paddlers.
...
- **KMA (Korea Meteorological Administration)** marine forecast: [www.weather.go.kr](https://www.weather.go.kr) — Korean, English version exists.
...
- Kayak with spray skirt (sea-touring class — see [Packable Sea Kayak Selection](/wiki/Packable-Sea-Kayak-Selection/))
...
See [Kayaking in Seoul and Incheon](/wiki/Kayaking-in-Seoul-and-Incheon/) for the Seoul-area training grounds.

## Related pages

- [Jeju Trifecta](/wiki/Jeju-Trifecta/) — the overarching project.
- [Jeju Olle Trail Challenge](/wiki/Jeju-Olle-Trail-Challenge/) — the walking/running loop.
- [Jeju Fantasy Bike Path Challenge](/wiki/Jeju-Fantasy-Bike-Path-Challenge/) — the bike loop.
- [Packable Sea Kayak Selection](/wiki/Packable-Sea-Kayak-Selection/) — choosing the right boat.
- [Kayaking in Seoul and Incheon](/wiki/Kayaking-in-Seoul-and-Incheon/) — training before Jeju.
- [Jeju Luggage Forwarding Services](/wiki/Jeju-Luggage-Forwarding-Services/) — moving gear between coastal hotels.
- [Gimpo to Jeju Flight Hacks](/wiki/Gimpo-to-Jeju-Flight-Hacks/) — getting yourself + boat to Jeju.
