---
permalink: /wiki/Why-Buy-Once-Software-Died/
title: "Why Buy Once Software Died"
date: 2026-05-24
tags: [zapps, history]
---
...
- Shipped on floppy disks or CDs
- Ran on a relatively fixed OS
...
- Price expectations collapsed
- Piracy increased
- Refunds became trivial
...
- Licenses replaced ownership
- DRM crept in
- Cloud dependence blurred boundaries
...
- Ownership shifted from user to provider
- Access became revocable
- Continuity depended on permission
...
- Tool-building costs are collapsing because of AI
- Many tools no longer need servers (static hosting, client-side WASM databases)
- Distribution is trivial
- Support can be minimal by design
...
- The tool owes you nothing
- You owe it nothing

That is the underlying idea behind [Zapps](/wiki/Zapp-Manifesto/).
