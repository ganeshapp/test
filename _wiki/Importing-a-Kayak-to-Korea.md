---
permalink: /wiki/Importing-a-Kayak-to-Korea/
title: "Importing a Kayak to Korea"
date: 2026-05-20
tags: [seed, bucketlist, kayaking, logistics, korea]
---
...
This page is written around Neris because that is the most common modern choice (see [Packable Sea Kayak Selection](/wiki/Packable-Sea-Kayak-Selection/)), but the process generalises to any direct international purchase of a sporting good over US$150.
...
For Neris specifically: **[neriskayaks.com](https://neriskayaks.com)** is the main factory portal. Their international distribution arm at **nerisadventures.com** also handles English-language sales and is sometimes faster to respond. Use the contact form on either site, or email their sales team directly (address listed on the site).

### What to include in the email

The Neris sales team is responsive but expects specifics. Be explicit about:

- **Model** — e.g., "Smart-1 TPU" or "Smart Pro XS with TPU skin upgrade." If you want a custom material on a model that ships standard in PVC, ask for it explicitly. Money-no-object customers regularly get custom builds.
- **Configuration** — Expedition Package (rudder + spray deck + waist skirt) for any ocean use.
- **Accessories** — dry bags sized to the cockpit, repair kit, spare sponson valves, pump.
- **Shipping** — air freight (DHL / FedEx / UPS) fully insured to your residential address in Seoul.
- **Payment preference** — international bank wire or corporate credit card.
- **Delivery address** — full Korean address in romanised form, plus your local Korean phone number with +82 country code.
...
>
> Best regards,
> *[Name]* / *[+82 phone]* / *[Seoul address]*

### What to expect back

A reply within 24–48 hours, typically including:

- A proforma invoice with itemised pricing.
- Manufacturing lead time (usually 2–3 weeks).
- Shipping cost (often €200–€450 depending on courier and insurance).
- IBAN / BIC for wire transfer, or a payment link.
...
1. Go to **[Unipass — Korea Customs Service](https://unipass.customs.go.kr)** (also reachable from a Naver or Google search).
...
- Replying to the courier's automated email/SMS notification.
- Logging into the DHL / FedEx Korea portal and registering your PCCC against the tracking number.
- Going to the courier's branch in person (rarely necessary).
...
- Inspect skin for shipping damage (rare; manufacturers pack well).
- Verify all listed items are present against the packing slip.
- Photograph any damage immediately and email Neris with the photos within 48 hours.
...
- **Korean Air / Asiana** — counts toward your normal checked bag allowance if under 23 kg and 158 cm linear. The Smart-1 TPU bag fits.
- **Jeju Air / T'way / Air Premia** — same baggage allowance rules; LCC fees apply for the second bag.
- International LCCs (Cebu Pacific, AirAsia, Lion Air) — usually fine but pay for the extra weight in advance to avoid airport surcharges.

For sea kayak transport on domestic Korean flights, see [Gimpo to Jeju Flight Hacks](/wiki/Gimpo-to-Jeju-Flight-Hacks/) (the kayak goes as a regular checked bag).

## Local accessory sourcing

These are easier to buy in Korea than to ship:

- **4-piece breakdown carbon paddle** — KayakMall (카약몰) in Seoul, Decathlon Korea, or the marine cluster shops near Dobongsan / Dongdaemun outdoor district.
- **PFD (inflatable life vest)** — same shops; ₩100,000–₩200,000.
- **Sponson pump / high-pressure pump** — same shops; ₩30,000–₩100,000.
- **VHF marine radio** (for serious ocean work) — limited Korean retail; easier to order from B&H Photo or Amazon US into your PCCC.

## Related pages

- [Packable Sea Kayak Selection](/wiki/Packable-Sea-Kayak-Selection/) — choosing the model to import.
- [Neris Smart-1 TPU](/wiki/Neris-Smart-1-TPU/) — most common import.
- [Neris Smart Pro XS](/wiki/Neris-Smart-Pro-XS/) — performance import.
- [Kayaking in Seoul and Incheon](/wiki/Kayaking-in-Seoul-and-Incheon/) — where to shake the new boat down.
- [Gimpo to Jeju Flight Hacks](/wiki/Gimpo-to-Jeju-Flight-Hacks/) — flying with the boat domestically.
