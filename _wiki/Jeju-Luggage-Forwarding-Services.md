---
permalink: /wiki/Jeju-Luggage-Forwarding-Services/
title: "Jeju Luggage Forwarding Services"
date: 2026-05-20
...
- [Jeju Trifecta](/wiki/Jeju-Trifecta/) — the project this enables.
- [Jeju Olle Trail Challenge](/wiki/Jeju-Olle-Trail-Challenge/) — the marquee use case.
- [Jeju Kayak Circumnavigation Challenge](/wiki/Jeju-Kayak-Circumnavigation-Challenge/) — moves the kayak between coastal hotels.
- [Jeju Fantasy Bike Path Challenge](/wiki/Jeju-Fantasy-Bike-Path-Challenge/) — cyclists use the same services for one-way rides.
