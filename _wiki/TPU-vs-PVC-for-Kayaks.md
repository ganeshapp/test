---
permalink: /wiki/TPU-vs-PVC-for-Kayaks/
title: "TPU vs PVC for Kayaks"
date: 2026-05-20
tags: [seed, bucketlist, kayaking, gear, materials]
---
...
For everyone else — and especially anyone planning the [Jeju Kayak Circumnavigation Challenge](/wiki/Jeju-Kayak-Circumnavigation-Challenge/) or tropical island travel — **pay for TPU**.
...
- [Packable Sea Kayak Selection](/wiki/Packable-Sea-Kayak-Selection/) — where this choice plays out.
- [Neris Smart-1 TPU](/wiki/Neris-Smart-1-TPU/) — the standard-issue TPU boat.
- [Neris Smart Pro XS](/wiki/Neris-Smart-Pro-XS/) — the boat where TPU is an explicit custom upgrade to request.
- [Importing a Kayak to Korea](/wiki/Importing-a-Kayak-to-Korea/) — how to specify the material when ordering.
